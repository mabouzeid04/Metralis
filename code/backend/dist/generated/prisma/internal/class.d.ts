 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.repairAction`: Exposes CRUD operations for the **RepairAction** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more RepairActions
      * const repairActions = await prisma.repairAction.findMany()
      * ```
      */
    get repairAction(): Prisma.RepairActionDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     ...
     * `prisma.workOrderPart`: Exposes CRUD operations for the **WorkOrderPart** model.
      ...
      * ```
      */
    get workOrderPart(): Prisma.WorkOrderPartDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
